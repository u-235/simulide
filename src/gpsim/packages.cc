...
//-------------------------------------------------------------------
//-------------------------------------------------------------------
float Package::get_pin_position(uint pin_number)
{
  return (bIsValidPinNumber(pin_number) ? m_pinGeometry[pin_number-1].pin_position : 0.0);
}

void Package::set_pin_position(uint pin_number, float position)
{
...
void Package::setPinGeometry(uint pin_number, float x, float y, 
...
PinGeometry *Package::getPinGeometry(uint pin_number)
{
...
string &Package::get_pin_name(uint pin_number)
{
...
//-------------------------------------------------------------------
//-------------------------------------------------------------------
int Package::get_pin_state(uint pin_number)
{
